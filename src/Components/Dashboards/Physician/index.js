...
const PhysicianDashboard = () => {
  ...
  const [topOrderingPhysicianData, setOrderingPhysicianData] = useState({});
  ...
  const chart = () => {
    ...
    axios
      .get(
        "https://dev-emrreporting.axcension.com/api/dashboard/getfinancialchartitems/provider/imedx/all"
      )
      .then((response) => {
        console.log(response);
        let months = response.data[1].SeriesValue.split(",");
        let billed = response.data[3].SeriesValue.split(",");
        let paid = response.data[5].SeriesValue.split(",");
    ...
    <Fragment>
      ...
      >
        ...
        <BottomRow
          ...
          topOrderingPhysicianData={topOrderingPhysicianData}
        />
        {/* Bottomn Card End */}
      </CSSTransitionGroup>
    </Fragment>
